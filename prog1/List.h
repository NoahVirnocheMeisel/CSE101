 ...
 *
 * @param	dataPrinter	Function to use to print out a piece of data in
 * the list
...
/**
 * @brief Gets the entry at the specified index and returns the data from that
 * entry.
 *
 * @param	L	The list to delete the entry from.
 * @param	i	The index of the entry to remove. 1st element has index
 * 0.
...
/**
 * @brief Deletes the entry at the specified index and returns the data from
 * that entry.
 *
 * @param	L	The list to delete the entry from.
 * @param	i	The index of the entry to remove. 1st element has index
